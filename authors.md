...
- **Frank Harrell**. Contributor.  
  rms author

- **Sergej Potapov**. Contributor.  
  survAUC author

- **Werner Adler**. Contributor.  
  survAUC author

- **Matthias Schmid**. Contributor.  
  survAUC author

## Citation

Source:
[`inst/CITATION`](https://github.com/nanxstats/hdnom/blob/v6.2.0/inst/CITATION)
