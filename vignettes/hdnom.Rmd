...
author: "Nan Xiao <<https://nanx.me>> <br> Miaozhu Li <<http://miaozhu.li>>"
date: "`r Sys.Date()`"
...
Let's generate a `hdnom.nomogram` object with `hdnom.nomogram()`
...
cmp.val <- hdnom.compare.validate(
  x, time, event,
...
```{r, fig.width = 8, fig.height = 6.4, out.width = 600, out.height = 480}
cmp.cal <- hdnom.compare.calibrate(
  x, time, event,
  model.type = c("lasso", "alasso"),
  method = "cv", nfolds = 5,
